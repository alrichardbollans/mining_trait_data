...
from name_matching_cleaning import get_genus_from_full_name
...
def get_reconciliations(in_df: pd.DataFrame, full_name_col: str, genus_col: str = None):
    ...
    if genus_col is None:
        genus_col = 'extracted_genus'
        df_copy[genus_col] = df_copy[full_name_col].apply(get_genus_from_full_name)
...
if __name__ == '__main__':
    ...
    # acc_df = get_reconciliations(df, 'fullname_w_auth')
