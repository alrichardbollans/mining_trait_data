...
class MyTestCase(unittest.TestCase):
    ...
    def test_antimal_output(self):
        ...
        logan_antiplasm_df = get_antimalarial_metabolite_hits_for_taxa(logan, os.path.join(test_output_dir,
                                                                                           'logan_antimal.csv'))

        lucida = logan_antiplasm_df[logan_antiplasm_df[wcvp_accepted_columns['name']] == 'Strychnos usambarensis'][
            kn_metabolite_name_column].values
