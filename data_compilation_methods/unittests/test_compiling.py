...
from data_compilation_methods import compile_hits, COL_NAMES, single_source_col, \
...
class MyTestCase(unittest.TestCase):
    ...
    def test_multiple_sources(self):
        ...
        pd.testing.assert_frame_equal(compiled.sort_values(by=wcvp_accepted_columns['name']).reset_index(drop=True),
                                      auto_compiled.sort_values(by=wcvp_accepted_columns['name']).reset_index(drop=True))
